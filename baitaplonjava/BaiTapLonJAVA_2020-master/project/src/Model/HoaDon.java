...
public class HoaDon extends ChiTietHoaDon {
    ...
    public HoaDon(MatHang bangDia, int soNgayDuocMuon, int soLuong) {
        super(bangDia, soNgayDuocMuon, soLuong);
    }

    public HoaDon(MatHang bangDia, int soNgayDuocMuon, int soLuong, String maHoaDon, KhachHang khachHang, Date ngayLap) {
        super(bangDia, soNgayDuocMuon, soLuong);
        this.maHoaDon = maHoaDon;
        this.khachHang = khachHang;
        this.ngayLap = ngayLap;
    ...
    public HoaDon(MatHang bangDia, int soNgayDuocMuon, int soLuong, String maHoaDon, KhachHang khachHang, Date ngayLap, boolean tinhTrang) {
    ...
    public HoaDon(MatHang bangDia, int soNgayDuocMuon, int soLuong, String maHoaDon, KhachHang khachHang) {
        super(bangDia, soNgayDuocMuon, soLuong);
        this.maHoaDon = maHoaDon;
        this.khachHang = khachHang;
    }
