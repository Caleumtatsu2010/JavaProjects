    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
            <ul class="navbar-nav m-auto">
                <c:if test="${sessionScope.acc.isSell == 1}">// Account.isSell in acc session ==1 , then Manager Product
                    <li class="nav-item">
                ...
                <c:if test="${sessionScope.acc == null}">//if acc has Account then can logout
                    <li class="nav-item">
                        <a class="nav-link" href="logout">Logout</a>
                    </li>
                </c:if>
                <c:if test="${sessionScope.acc != null}">//if acc hasn't Account then can login
                    <li class="nav-item">
